...
<div class="docs-example code codeblock">sqlite3  /var/archivematica/automation-tools/transfers-std.db
...
3|e0bf1ae3-fa78-41a8-9fc1-8ad5349b2371|logs|transfer|PRO
</div>
4\. Remove the failed transfer:
  <div class="docs-example code codeblock">sqlite> delete from unit where id=3;
sqite> .quit
</div>
