...
Coordinate with Artefactual, RAC Information Systems Manager, and other key [RAC staff](https://docs-internal.rockarch.org/systems-info-sheets/archivematica-info-sheet/) to plan upgrade at least 3 weeks in advance. Production and development upgrade should be planned at the same time, with production scheduled for 2 weeks after development. The upgrade schedule will likely look like:
...
* Setting up dev VMs in accordance with [current specs](https://docs-internal.rockarch.org/systems-info-sheets/archivematica-info-sheet/)
* Setting up ssh access for [select RAC staff](https://docs-internal.rockarch.org/systems-info-sheets/archivematica-info-sheet/) for VMs
* Setting up all accounts and access for Artefactual
* Configuring [DNS](https://docs-internal.rockarch.org/systems-info-sheets/archivematica-info-sheet/)
...
* All expected [user accounts](https://docs.rockarch.org/systems-info-sheets/archivematica-info-sheet/) are present
* Transfers can be sent to and stored in all locations on both pipelines
  * Turn off the Fornax Start Transfer service in the Zodiac dashboard before testing
  * Once all tests are completed successfully, turn the Fornax Start Transfer service back on
